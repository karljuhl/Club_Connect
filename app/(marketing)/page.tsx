...
<section 
  style={{ 
    backgroundImage: "linear-gradient(to bottom, rgba(245, 245, 245, 1) 0%, rgba(245, 245, 245, .3) 30%, rgba(245, 245, 245, .3) 70%, rgba(245, 245, 245, 1) 100%), url('/grid.svg')",
...
>
      ...
      <section data-aos="fade-up" className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 py-12 md:py-24 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <div className="space-x-4 space-y-4 shadow-2xl">
        ...
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <div className="min-w-[85%] min-h-[15rem] text-left items-left pt-6">
            <iframe
              ...
              className="overflow-hidden border border-1 shadow-2xl rounded-lg w-full h-[65vh]"
      ...
      <section data-aos="fade-up" id="features" className="container space-y-6 py-12 md:py-24 lg:py-32">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Quick to create, easy to manage. Create a document with your facility&apos;s information and we finish the job.
          </p>
          <div className="mx-auto text-center md:max-w-[58rem] mt-8">
          <Link href="/roadmap" className={cn(buttonVariants({ size: "lg" }))}>
            <Icons.add className="h-4 w-4 mr-2"></Icons.add>
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3 mt-6">
          <div className="shadow-2xl relative overflow-hidden rounded-lg  bg-background p-2 bg-slate-200">
          ...
          <div className="shadow-2xl relative overflow-hidden rounded-lg bg-background p-2 bg-emerald-200">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
          ...
          <div className="shadow-2xl relative overflow-hidden rounded-lg bg-background p-2 bg-green-200">
            <div className="flex h-[180px] flex-col justify-between rounded-md p-6">
